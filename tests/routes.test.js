...
describe('Testing the API', () => {
  ...
  it('Reading the allergies updated : GET', async (done) => {
    ...
    const id = '45678G'
    expect(res.type).toEqual('application/json')
    expect(res.body[0]['?descripcion'].value).toContain('https://oth2.solid.community/symmetry/45678G/CausesU0020multipleU0020organU0020failure')
    expect(res.body[0]['?id'].value).toContain('https://oth2.solid.community/symmetry/45678G/Alergias.ttl#1')
    expect(res.body[0]['?nombre'].value).toContain('https://oth2.solid.community/symmetry/45678G/AlergiaU00201U0020CHANGED')
  ...
  it('Reading the allergies after deletion : GET', async (done) => {
    ...
    expect(res.body[0]['?nombre'].value).toContain('https://oth2.solid.community/symmetry/45678G/AlergiaU00201U0020CHANGED')
    expect(res.body[0]['?propietario'].value).toContain('https://oth2.solid.community/symmetry/45678G/1738457')
    expect(res.body[1]['?descripcion'].value).toContain('https://oth2.solid.community/symmetry/45678G/NoU0020puedeU0020respirarU0020bien')
    expect(res.body[1]['?id'].value).toContain('https://oth2.solid.community/symmetry/45678G/Alergias.ttl#3')
    expect(res.body[1]['?nombre'].value).toContain('https://oth2.solid.community/symmetry/45678G/AlergiaU00203')
    expect(res.body[1]['?propietario'].value).toContain('https://oth2.solid.community/symmetry/45678G/8673935')
    done()
  })
